...
class ProcessWithIndependentPipelinesUseCase:
    ...
    def __init__(
        ...
        pat_pipeline: PatPipeline | None = None,
        xgboost_pipeline: XGBoostPipeline | None = None,
    ):
        """Initialize with services."""
        self.data_parsing_service = data_parsing_service or DataParsingService()

        # Initialize pipelines if not provided
        self.pat_pipeline: PatPipeline | None = pat_pipeline
        ...
        self.xgboost_pipeline: XGBoostPipeline | None = xgboost_pipeline
